...
Revision ID: a60d1c42f32e
Revises: 
Create Date: 2025-06-06 12:00:59.204785
...
def upgrade() -> None:
    ...
    sa.Column('price_per_hour', sa.String(), nullable=True),
    sa.Column('price_per_foo', sa.String(), nullable=True),
    ...
    sa.Column('boobs', sa.String(), nullable=True),
